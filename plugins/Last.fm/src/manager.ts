...
class PluginManager {
  ...
  private handleError(error: Error) {
    ...
    if (this.consecutiveFailures >= Constants.MAX_RETRY_ATTEMPTS) {
      console.log(
        `[Last.fm] Failed ${this.consecutiveFailures} times, initiating reconnection...`,
      );
  ...
  private startReconnection() {
    ...
    console.log("[Last.fm] Starting reconnection process");
    this.reconnectTimer = setInterval(() => {
      console.log("[Last.fm] Attempting to reconnect...");
      this.initialize()
        .then(() => {
          console.log("[Last.fm] Reconnection successful");
          this.stopReconnection();
        })
        .catch((error) => {
          console.log("[Last.fm] Reconnection failed:", error);
        });
  ...
  public async initialize() {
    ...
    console.log(`[Last.fm] Update timer started with interval: ${interval}ms`);
  }
  ...
  public stop() {
    ...
    this.stopReconnection();
    clearActivity();
    console.log("[Last.fm] Plugin stopped");
  }
}
