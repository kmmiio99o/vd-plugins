// Time helpers for the scrobble plugin
...
export function validateTimestamps(
    ...
    const twoHoursFuture = now + 2 * 60 * 60; // 2 hours in future (more lenient)
    ...
    if (endTime !== undefined) {
        ...
        const maxDuration = 2 * 60 * 60; // 2 hours max - pretty generous
